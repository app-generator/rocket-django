...
| ✓ [API](https://rocket-django.onrender.com/api/product/) via `DRF` | ✅ **React** / `ApexCharts`                                                   | ✅ **30 days Delivery Warranty**    |
| ✓ [Celery](https://rocket-django.onrender.com/tasks/)              | ✅ **Multi-Language** (i18n)                                                  | ✅ [CI/CD for AWS, DO](https://appseed.us/terms/#section-ci-cd) **(Extra)**    |
| ✓ `Docker`                                                         | ✅ **Sentry** `Error Reporting`                                               |  -                                   |
| ✓ `Free Support` (GitHub Issues)                                   | ✅ **[Premium Support](https://appseed.us/support/)**                         |  -                                   |
| -                                                                  | ✅ `Unlimited Projects`                                                       |  -                                   |
| -                                                                  | ✅ `Private REPO Access`                                                      |  -                                   |
| -                                                                  | ✅ `Lifetime Updates`                                                         |  -                                   |
| ------------------------------------| ------------------------------------| ------------------------------------|
